...
class JAXModel_lv(JAXModel):
    ...
    def __init__(self):
        ...
        self.parameters = jnp.array([1.30000000000000, 0.900000000000000, 0.800000000000000, 1.80000000000000, 0.0])
        super().__init__()
    ...
    def _xdot(self, t, x, args):
        ...
        prey, predator,  = x
        alpha, beta, gamma, delta, net1_output1,  = p
        _ = tcl
        _ = h
        flux_v1, flux_v2, flux_v3, flux_v4,  = self._w(t, x, p, tcl, h)

        dpreydt = flux_v1 - flux_v3
        dpredatordt = -flux_v2 + flux_v4
    ...
    def _w(self, t, x, p, tcl, h):
        ...
        flux_v1 = alpha*prey
        flux_v2 = delta*predator
        flux_v3 = beta*predator*prey
        flux_v4 = gamma*predator*prey

        return jnp.array([flux_v1, flux_v2, flux_v3, flux_v4])

    def _x0(self, t, p):
        alpha, beta, gamma, delta, net1_output1,  = p

        x00 = 0.442492960000000
        x01 = 4.62805940000000
    ...
    def _y(self, t, x, p, tcl, h, op):
        ...
        prey_o = self.nns['net1'].forward(jnp.array([prey, predator]))[0]
        predator_o = predator
    ...
    def _root_cond_fn(self, t, y, args, **_):
        ...
        _ = tcl
        _ = h
        flux_v1, flux_v2, flux_v3, flux_v4,  = self._w(t, y, p, tcl, h)
    ...
    def parameter_ids(self):
        return "alpha", "beta", "gamma", "delta", "net1_output1", 

    @property
    def expression_ids(self):
        return "flux_v1", "flux_v2", "flux_v3", "flux_v4", 
