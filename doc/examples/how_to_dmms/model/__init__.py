...
net3 = _module_from_path('net3', Path(__file__).parent / 'net3.py')
...
class JAXModel_lv(JAXModel):
    ...
    def __init__(self):
        ...
        self.nns = {"net3": net3.net(jr.PRNGKey(0))}
        self.parameters = jnp.array([1.30000000000000, 0.900000000000000, 0.800000000000000, 1.80000000000000])
        super().__init__()
